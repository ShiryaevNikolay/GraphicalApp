package io.medicalvoice.graphicalapp.lighttexture.renderer;
...
import io.medicalvoice.graphicalapp.lighttexture.shader.Shader;
...
public class OpenGLRenderer implements GLSurfaceView.Renderer
{
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mTexture0=new Texture(context, R.drawable.texture1);
        mTexture1=new Texture(context,R.drawable.texture2);
