...
//                                                                R.drawable.box4, R.drawable.box5});
        texture = TextureUtils.loadTextureCube(context, new int[]{R.drawable.back1, R.drawable.bottom2,
                R.drawable.top3, R.drawable.front0,
                R.drawable.left4, R.drawable.right5});
